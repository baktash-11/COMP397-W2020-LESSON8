module managers
{
    ...
    {
        //need two objects of type GameObject
        ...
        //finding the tope left of(objects) player
        public static AABBCheck(object1:objects.GameObject, object2:objects.GameObject):boolean
        {
             //for collision detection have to search  "aabb collision detection"
            //link of r collision dectction https://developer.mozilla.org/en-US/docs/Games/Techniques/2D_collision_detection
                                //if this is true    assign this objectOffset 0, 0   else                assign this to object1Offset 
            ...
            // if the object is centered it will subruct half width(Means will go to 0,0) if its not centered will subtruct 0 :)
